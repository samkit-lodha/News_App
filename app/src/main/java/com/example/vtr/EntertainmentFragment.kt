...
import com.example.vtr.databinding.FragmentEntertainmentBinding
...
class EntertainmentFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        recyclerView = binding.recyclerViewEnter
    ...
    private fun getNews(){
        val news : Call<News> = NewsServices.newsInterface.getEntertain("in",1)
