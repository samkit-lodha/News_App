...
import com.example.vtr.databinding.FragmentTechnologyBinding
...
class TechnologyFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        recyclerView = binding.recyclerViewTech
    ...
    private fun getNews() {
        val news : Call<News> = NewsServices.newsInterface.getTech(1)
