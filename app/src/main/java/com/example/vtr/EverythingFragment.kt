...
import com.example.vtr.databinding.FragmentEverythingBinding
...
class EverythingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        recyclerView = binding.recyclerViewEvery
    ...
    private fun getNews() {
        val news : Call<News> = NewsServices.newsInterface.getEverything(1)
